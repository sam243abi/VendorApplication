...
const UploadScreen = () => {
  ...
  const [uploadedFiles, setUploadedFiles] = useState([
    { id: 1, name: "Shopping item sheet.xls", size: "10MB", date: "8 Sep 2021 08:44 PM" },
    { id: 2, name: "Grocery item sheet.xls", size: "11.3MB", date: "8 Sep 2021 08:44 PM" },
    { id: 3, name: "Pharmacy item sheet.xls", size: "9.3MB", date: "8 Sep 2021 08:44 PM" },
    { id: 4, name: "Shopping Women sheet.xls", size: "10.3MB", date: "8 Sep 2021 08:44 PM" },
  ]);

  const [uploadingFiles, setUploadingFiles] = useState([
    { id: 1, name: "Shopping item sheet.xls", uploaded: "8.3MB", total: "10MB", progress: 0.83 },
    { id: 2, name: "Grocery item sheet.xls", uploaded: "9.1MB", total: "11.3MB", progress: 0.81 },
  ]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.navBar}>
        ...
        >
          <Text style={[styles.tabText, activeTab === "Uploading" && styles.activeText]}>Uploading Files</Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          uploadedFiles.map((file) => (
            <View key={file.id} style={styles.card}>
              <View style={styles.fileInfo}>
                <Image source={require("../assets/excel-icon.png")} style={styles.icon} />
                <View>
          ...
          uploadingFiles.map((file) => (
            <View key={file.id} style={styles.card}>
              ...
              <TouchableOpacity onPress={() => handleFileUpload(file.id)}>
                <Icon name="arrow-right-circle" size={20} color="#007bff" style={styles.uploadIcon} />
              </TouchableOpacity>
            </View>
          ))
        )}
